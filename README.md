...
Python • SQL • R (basic) • HTML • CSS

📊 Data Analysis & Visualization:
Power BI • Tableau • IBM SPSS • Microsoft Excel • Orange Data Mining

🤖 Machine Learning & Deep Learning:
Scikit-learn • TensorFlow • Keras • PyTorch • NLP • LLMs • Explainable AI

📈 Statistical Tools & Techniques:
Hypothesis Testing • Regression Analysis • Data Cleaning • Feature Engineering • Predictive Modeling

☁️ Big Data & Cloud Tools:
Hadoop • Google Colab • Jupyter Notebook
